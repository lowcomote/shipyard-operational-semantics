...
/**
 * This is the item provider adapter for a {@link shipyardV4.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShipyardV4Package.Literals.TRIGGER__TRIGGER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Trigger.class)) {
			case ShipyardV4Package.TRIGGER__TRIGGER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShipyardV4Package.Literals.TRIGGER__TRIGGER,
				 ShipyardV4Factory.eINSTANCE.createTriggerEvent()));

		newChildDescriptors.add
			(createChildParameter
				(ShipyardV4Package.Literals.TRIGGER__TRIGGER,
				 ShipyardV4Factory.eINSTANCE.createTriggerSelector()));
	}
