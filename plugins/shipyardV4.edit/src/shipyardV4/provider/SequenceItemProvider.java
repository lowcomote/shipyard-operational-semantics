...
/**
 * This is the item provider adapter for a {@link shipyardV4.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShipyardV4Package.Literals.SEQUENCE__SEQUENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShipyardV4Package.Literals.SEQUENCE__SEQUENCE,
				 ShipyardV4Factory.eINSTANCE.createSequenceName()));

		newChildDescriptors.add
			(createChildParameter
				(ShipyardV4Package.Literals.SEQUENCE__SEQUENCE,
				 ShipyardV4Factory.eINSTANCE.createSequenceTriggeredOn()));

		newChildDescriptors.add
			(createChildParameter
				(ShipyardV4Package.Literals.SEQUENCE__SEQUENCE,
				 ShipyardV4Factory.eINSTANCE.createSequenceTasks()));
	}
